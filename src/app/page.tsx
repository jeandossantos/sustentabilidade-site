...
export default function Home() {
  return (
    <>
      ...
      <p className='mt-3'>
        <span className='font-bold'>Sustentabilidade</span> é um conceito que se
        refere à capacidade de atender às necessidades do presente sem
        comprometer a capacidade das futuras gerações de atenderem às suas
        próprias necessidades. É um equilíbrio entre desenvolvimento econômico,
      ...
      <p className='mt-3'>
        O conceito moderno de sustentabilidade começou a ganhar destaque global
        na década de 1980. Um marco importante foi o Relatório Brundtland,
        publicado em 1987 pela Comissão Mundial sobre Meio Ambiente e
        Desenvolvimento das Nações Unidas. O relatório, intitulado &quot;Nosso
        Futuro Comum&quot;, introduziu o conceito de desenvolvimento
      ...
      <p className='mt-4 text-center font-semibold text-green-700'>
        Explore nosso site para saber mais sobre como podemos contribuir juntos
        para um planeta mais sustentável e saudável.
      </p>
    </>
  );
}
